document.querySelector(
  ...
  `<button type="checkbox" id="hideSolvedProblems" class="btn btn-primary">Ascunde probleme rezolvate (pe aceasta pagina)</button>`;
...
hideSolvedProblemsButton.addEventListener("click", (event) => {
  [...document.querySelectorAll(".card > .card-footer > div > div > a > span.badge")]
